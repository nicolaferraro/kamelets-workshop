...
```
([^ execute](didact://?commandId=vscode.didact.sendNamedTerminalAString&text=newTerminal$$jbang%20--fresh%20-Dcamel.jbang.version=3.13.0%20--deps=org.apache.camel.kamelets:camel-kamelets:0.5.0%20CamelJBang@apache/camel%20run%20example.yaml))
